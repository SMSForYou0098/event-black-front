...
const TermsConditions = () => {
  return (
    <div style={{ backgroundColor: '#0a0a0a', minHeight: '100vh', color: '#fff' }}>
      {/* Hero Section */}
      <section className="terms-hero text-white py-5" style={{ paddingTop: '5rem', paddingBottom: '5rem' }}>
            ...
            <Col lg={12}>
              ...
              <div className="terms-section">
                ...
                <div className="terms-content">
                  ...
                  <p>
                    By registering, accessing, browsing and/or using the Platform as a "User" (which means a person or any legal entity who uses the Platform to get information or purchases tickets for any upcoming events in the city), or as an "Organizer" (which means creators publishing, promoting and selling tickets of their upcoming events to the Users on the Platform), a) you agree to be bound by these Terms and acknowledge having read the privacy policy located at 401, BLUE CRYSTAL COM, OPP. WATER TANK, Vallabh Vidyanagar, Anand-388120, Gujarat, India ("Privacy Policy") you have the legal capacity and are competent to enter into this agreement; c) in the event you are entering into these Terms on behalf of any entity/company or its group, you possess the requisite authority to bind such entities, company or its groups to these Terms. If you do not agree to these Terms, you should immediately cease using our Platform. Get Your Ticket, User, and the Organiser will be individually referred to as Party and collectively as Parties.
                  </p>
                </div>
              </div>
              ...
              {/* User Rights */}
              <div className="terms-section">
                <h2 className="section-title">User Right</h2>
                <div className="terms-content">
                  <p>
              ...
              {/* Organiser Rights */}
              <div className="terms-section">
                <h2 className="section-title">Organiser Right</h2>
                <div className="terms-content">
                  <p>
              ...
              <div className="terms-section">
                <h2 className="section-title">Organiser's Brand and Event Page</h2>
                <div className="terms-content">
                  <p>
              ...
              {/* Sale of Tickets */}
              <div className="terms-section">
                <h2 className="section-title">Sale of Tickets</h2>
                <div className="terms-content">
                  <p>
              ...
              {/* Payment and Refunds */}
              <div className="terms-section">
                <h2 className="section-title">Payment and Refunds</h2>
                <div className="terms-content">
                  <p>
                  ...
                  <p>
                    Upon receiving the Event Registration Fee from the Users, Get Your Ticket shall withhold the payments to the Organisers for 30 days, post the event to see if there are any complaints from the Users relating to the event ("Withholding Period"). Upon receiving complaints, if Get Your Ticket in its sole discretion believes that the event published by the Organizer is or is likely to be in violation of these Terms, Get Your Ticket will refund the Base Price to the Users with or without notice to the Organiser. On completion of the Withholding Period without any complaints, Get Your Ticket shall transfer the Base Price to the Organiser. The amount shall be transferred to the Organiser's bank account, details of which shall be provided in the payout settings on the Platform at the time of the creation of the Brand Page.
                  </p>
                  <p>
              ...
              {/* Advanced Plans */}
              <div className="terms-section">
                <h2 className="section-title">Advanced Plans</h2>
                <div className="terms-content">
                  <p>
              ...
              {/* Marketing Fee */}
              <div className="terms-section">
                <h2 className="section-title">Marketing Fee</h2>
                <div className="terms-content">
                  <p>
              ...
              <div className="terms-section">
                ...
                <div className="terms-content">
                  ...
                  <p>
                    Organiser shall only use the name, logo, or such other names or logos used by Get Your Ticket ("Get Your Ticket Marks") to refer to the Platform to identify itself as an Organiser using the Platform for publishing and promoting events; provided that Organiser does not claim or attempt to claim, now or in the future, any rights in the Get Your Ticket Marks, degrade the distinctiveness of the Get Your Ticket Marks, or use the Get Your Ticket Marks to disparage or misrepresent Get Your Ticket, and its Platform.
                  </p>
                  <p>
                    Organiser and the User shall own the rights to all the data including any personal data that they provide to Get Your Ticket. Get Your Ticket shall have a right to process such data for the purpose of providing, supporting, operating, maintaining, and improving the Platform. We shall also have the right to re-use any and all techniques and know-how gathered while providing the Platform to the Organiser and the User. Get Your Ticket shall have a perpetual right and license to incorporate into the Platform or otherwise use any suggestions, enhancement requests, recommendations, or other feedback it receives from the Organiser or the User. Notwithstanding anything to the contrary in these Terms, Get Your Ticket may collect and use query logs, and any data relating to the operation, support, and/or about the Organisers' or Users' use of the Platform, Get Your Ticket websites, ("Usage Data") to develop, improve, support and operate its Platform. All rights not expressly provided to You herein are reserved.
                  </p>
                </div>
              </div>
              ...
              <div className="terms-section">
                ...
                <div className="terms-content">
                  ...
                  <p>
                    Get Your Ticket may terminate the access to the Platform at any time if Get Your Ticket believes that a User or an Organiser (a) has violated these Terms; (b) if allowing access and use of the Platform would violate any applicable local, state, provincial, national and other laws, rules and regulations or would expose Get Your Ticket to legal liability. Get Your Ticket in its sole discretion with or without notice may terminate the Organiser's or User's access to the Platform without any liability due to any business reason. Get Your Ticket may choose to stop offering the Platform, or any particular portion of the Platform, or modify or replace any aspect of the Platform, at any time. Get Your Ticket shall take reasonable efforts to notify the Organisers or Users in the event, such modification, or termination of the access to the Platform, materially prejudice either the Organiser or the User.
                  </p>
                  <div className="highlight-box">
                    <strong>Effect of Termination:</strong> Following the termination either by the Organiser, User or Get Your Ticket, the Organisers' and Users' access and use of the Platform shall cease. Get Your Ticket shall retain all data provided by the Organiser or the User in its possession for a period of thirty (30) days from the date of effective termination ("Data Retention Period"). Beyond the Data Retention Period, Get Your Ticket reserve the right to delete all such data in its possession.
                  </div>
                </div>
              </div>
              ...
              <div className="terms-section">
                <h2 className="section-title">Confidentiality; Security and Data Privacy</h2>
                <div className="terms-content">
                  <p>
                  ...
                  <p>
                    Confidential Information means all information disclosed by one Party to the other Party which is in tangible form and labelled "confidential" (or with a similar legend) or which a reasonable person would understand to be confidential given the nature of the information and circumstances of disclosure. For purposes of these Terms, the data of the Users collected by the Organiser on the Event Page shall be deemed Confidential Information. Notwithstanding the foregoing, Confidential Information shall not include any information which (a) becomes publicly known and made generally available after disclosure by the disclosing party to the receiving party through no action or inaction of the receiving party; (b) is, at the time of disclosure, already in the possession of the receiving party without any obligation of confidentiality; (c) is obtained by the receiving party from a third party without a breach of such third party's obligations of confidentiality; I is independently developed by the receiving party without the use of or reference to the disclosing party's Confidential Information; or (d) is required by law to be disclosed by the receiving party, provided that the receiving party shall, to the extent legally permitted, notify the disclosing party of such requirement prior to disclosing so that the disclosing party may seek a protective order or other appropriate relief.
                  </p>
                  <p>
                    Get Your Ticket shall process such personal data forming part of the data the Organiser or the User provided Get Your Ticket only for the purposes of (i) providing, maintaining, operating, supporting, and improving the Platform and in accordance with these Terms, the Privacy Policy and any other applicable data privacy laws and as part of the direct relationship between Get Your Ticket and the Organiser or the User. Get Your Ticket shall not process such data for any purposes other than what is mentioned in these Terms. Get Your Ticket certify that they understand the restrictions in this clause and will comply with such restrictions. Get Your Ticket shall use appropriate technical and organizational measures to protect such data. The measures used are designed to provide a level of security appropriate to the risk of processing such data. Get Your Ticket shall, without undue delay, notify the Organiser or User of any accidental or unlawful destruction, loss, alteration, unauthorized disclosure of, or access to their data that is processed by Get Your Ticket.
                  </p>
                  <p>
                    User and Organiser acknowledge and agree that Get Your Ticket and our group companies may access or disclose information about the User, Organiser, including any personal data, in order to (a) comply with the law or respond to lawful requests or legal process; or (b) prevent any infringement of group companies' or Get Your Ticket customers' proprietary rights. Further, at Get Your Ticket sole discretion, any suspected fraudulent, abusive, or illegal activity by the User or Organiser may be referred to law enforcement authorities.
                  </p>
                </div>
              </div>
              ...
              <div className="terms-section">
                <h2 className="section-title">User Data Collected by the Organiser</h2>
                <div className="terms-content">
                  <p>
