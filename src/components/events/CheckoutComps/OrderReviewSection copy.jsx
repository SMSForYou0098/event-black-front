...
export const OrderReviewSection = ({
  ...
  >
    <div className="checkout-review-order shadow-sm overflow-hidden">
      <div className="rounded-4 custom-dark-bg">
        <div className="title d-flex justify-content-center p-4">
          <h4 className="mb-4 fw-500 text-center border-bottom  pb-2 custom-text-secondary border-primary">Your Order</h4>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <div className="fs-5 fw-bold custom-text-secondary">
          ...
          {/* Tickets Count */}
          <div className="custom-dark-content-bg d-flex justify-content-between align-items-center  p-3 rounded-4">
