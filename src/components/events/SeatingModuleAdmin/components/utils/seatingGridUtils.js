...
/**
 * Pure utility functions for seating grid calculations.
 * These are separated to avoid re-running on every render.
 */
...
export const STORAGE_KEY_PREFIX = 'seatingView_';
export const VIEW_PERSIST_DEBOUNCE_MS = 500;
export const STORED_BOUNDS_EPS_PX = 2;
export const BOOKING_MIN_SEAT_GAP_PX = 4;
...
export function getRowMinCenterPitch(seats) {
...
export function calculateTotalSeats(sections) {
